...
/**
 * Enumeration des types de condition
 * 
 * @author David Wayntal
 *
 */
public enum ConditionEntities {
	nePossedePasUneRecompense, possedeUnObjetParmi, aReponduCorrectement,
	accesLibre, accesUnique, accesTemporise, possedeUnToken,
}
