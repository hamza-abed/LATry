 ...
 */
public class GroupTokens implements SharableReflexEditable,Runnable {
	 ...
	 * 
	 */
	public GroupTokens(Group group) {
		this.group = group;
		this.game = group.getWorld().getGame();
	}
	...
	public String getKey() {
		return LaComponent.groupToken.prefix() + group.getId();
	}
	...
	public synchronized void run() {
		//group.getWorld().getGame().commitOnServer(this);	
