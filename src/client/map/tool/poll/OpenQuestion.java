...
public class OpenQuestion extends PollQuestion {
	 ...
	 * @param question
	 */
	public OpenQuestion(Element question) {
		super(question);
	}
	...
	public void addAnswer(Element parent) {
		Element element = XMLUtils.addFinalElement(parent, "question", answer);
		element.setAttribute("type", "open");
