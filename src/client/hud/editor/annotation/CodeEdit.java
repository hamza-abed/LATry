...
import client.hud.editor.ScriptEditWindow;
 ...
 */
public class CodeEdit extends BContainer {
	private AnnotationEditor editor;

	/**
	 * 
	 */
	public CodeEdit(final EditAnnotationWindow window,final Field f) {
		super();
		...
		LaBButton button = new LaBButton("code");
		button.addListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent event) {
				new ScriptEditWindow(editor, f);
			}
		});
		this.add(button);
