 ...
 */
public class FileEdit extends BContainer {
	private AnnotationEditor editor;

	/**
	 * 
	 */
	public FileEdit(final EditAnnotationWindow window,final Field f) {
		super();
