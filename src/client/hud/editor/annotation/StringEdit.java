 ...
 */
public class StringEdit extends BContainer {
	private AnnotationEditor editor;

	/**
	 * 
	 */
	public StringEdit(final EditAnnotationWindow window,final Field f) {
		super();
		...
		final BTextField text = new BTextField(""+editor.get(f));
		text.addFocusListener(new FocusListener() {
			@Override
			public void focusLost(FocusEvent event) {
				editor.setStr(f,text.getText());
