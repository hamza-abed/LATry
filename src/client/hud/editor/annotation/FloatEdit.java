 ...
 */
public class FloatEdit extends BContainer {
	 ...
	 * 
	 */
	public FloatEdit(EditAnnotationWindow w, Field f) {
		super();
		...
		LaBButton plus = new LaBButton(IconUtil.getIcon(FileLoader
				...
				new ActionListener() {
					public void actionPerformed(ActionEvent event) {
						editor.setFloat(field, editor.getFloat(field)+1);
						text.setText(Float.toString(editor.getFloat(field)));
					}
				}, "add");
		...
		text = new BTextField(Float.toString(editor.getFloat(field)));
		text.addFocusListener(new FocusListener() {
			@Override
			public void focusLost(FocusEvent event) {
				editor.setFloat(field,text.getText());
				text.setText(Float.toString(editor.getFloat(field)));
			}
			@Override
